...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Fix dead URLs found in crawl to eliminate 404s and thin-content artifacts.
      // ===========================================
      { source: '/brands/atlas', destination: '/brands', permanent: true },
      { source: '/commercial-systems/modified-bitumen', destination: '/commercial-systems/built-up-roofing', permanent: true },
      { source: '/guides/insurance-claims-guide', destination: '/insurance-claim-roofing-charlotte-nc', permanent: true },
      { source: '/materials/wood-shakes', destination: '/cedar-shake-roofing-charlotte-nc', permanent: true },
      { source: '/problems/ice-dams', destination: '/ice-dam-prevention-charlotte-nc', permanent: true },
      { source: '/problems/poor-ventilation', destination: '/roof-ventilation-charlotte-nc', permanent: true },

      // Old /services/* slugs
      { source: '/services/chimney-repair', destination: '/chimney-flashing-repair-charlotte-nc', permanent: true },
      { source: '/services/fascia-soffit', destination: '/fascia-soffit-repair-charlotte-nc', permanent: true },
      { source: '/services/flashing-repair', destination: '/roof-flashing-repair-charlotte-nc', permanent: true },
      { source: '/services/flat-roofing', destination: '/flat-roof-repair-charlotte-nc', permanent: true },
      { source: '/services/insulation', destination: '/attic-moisture-control-charlotte-nc', permanent: true },
      { source: '/services/roof-cleaning', destination: '/moss-algae-removal-roof-charlotte-nc', permanent: true },
      { source: '/services/roof-coating', destination: '/roof-coating-charlotte-nc', permanent: true },
      { source: '/services/roof-maintenance', destination: '/roof-maintenance-charlotte-nc', permanent: true },
      { source: '/services/shingle-roofing', destination: '/asphalt-shingle-roofing-charlotte-nc', permanent: true },
      { source: '/services/skylights', destination: '/skylight-installation-charlotte-nc', permanent: true },
      { source: '/services/slate-roofing', destination: '/slate-roofing-charlotte-nc', permanent: true },
      { source: '/services/tile-roofing', destination: '/tile-roofing-charlotte-nc', permanent: true },
      { source: '/services/ventilation', destination: '/roof-ventilation-charlotte-nc', permanent: true },

      // Old /products/* slugs (non-shingle product pages and old product names)
      { source: '/products/atlas-pinnacle-pristine', destination: '/asphalt-shingle-roofing-charlotte-nc', permanent: true },
      { source: '/products/certainteed-presidential', destination: '/products/certainteed-presidential-shake', permanent: true },
      { source: '/products/owens-corning-trudefinition', destination: '/products/owens-corning-trudefinition-duration', permanent: true },
      { source: '/products/standing-seam-metal', destination: '/standing-seam-metal-roof-charlotte-nc', permanent: true },
      { source: '/products/gutter-helmet', destination: '/gutter-guards-charlotte-nc', permanent: true },
      { source: '/products/leafguard-gutters', destination: '/leafguard-gutters-charlotte-nc', permanent: true },
      { source: '/products/sun-tunnel-skylights', destination: '/skylight-installation-charlotte-nc', permanent: true },
      { source: '/products/velux-skylights', destination: '/velux-skylights-charlotte-nc', permanent: true },

      // Unsupported Charlotte neighborhood slugs (redirect to the Charlotte city page)
      { source: '/locations/charlotte-nc/beverly-woods', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/locations/charlotte-nc/cotswold', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/locations/charlotte-nc/hickory-grove', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/locations/charlotte-nc/madison-park', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/locations/charlotte-nc/montclaire', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/locations/charlotte-nc/mountain-island', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/locations/charlotte-nc/prosperity-village', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/locations/charlotte-nc/providence', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/locations/charlotte-nc/sedgefield', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/locations/charlotte-nc/west-charlotte', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/locations/charlotte-nc/wilmore', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/neighborhoods/beverly-woods', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/neighborhoods/cotswold', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/neighborhoods/hickory-grove', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/neighborhoods/madison-park', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/neighborhoods/montclaire', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/neighborhoods/mountain-island', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/neighborhoods/prosperity-village', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/neighborhoods/providence', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/neighborhoods/sedgefield', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/neighborhoods/west-charlotte', destination: '/locations/charlotte-nc', permanent: true },
      { source: '/neighborhoods/wilmore', destination: '/locations/charlotte-nc', permanent: true },

      // Story slugs with no PMI data
      { source: '/stories/belmont', destination: '/stories', permanent: true },
      { source: '/stories/bessemer-city', destination: '/stories', permanent: true },
      { source: '/stories/cherryville', destination: '/stories', permanent: true },
      { source: '/stories/chester', destination: '/stories', permanent: true },
      { source: '/stories/china-grove', destination: '/stories', permanent: true },
      { source: '/stories/claremont', destination: '/stories', permanent: true },
      { source: '/stories/clover', destination: '/stories', permanent: true },
      { source: '/stories/conover', destination: '/stories', permanent: true },
      { source: '/stories/cramerton', destination: '/stories', permanent: true },
      { source: '/stories/fairview', destination: '/stories', permanent: true },
      { source: '/stories/hemby-bridge', destination: '/stories', permanent: true },
      { source: '/stories/hickory', destination: '/stories', permanent: true },
      { source: '/stories/indian-land', destination: '/stories', permanent: true },
      { source: '/stories/kings-mountain', destination: '/stories', permanent: true },
      { source: '/stories/lake-norman', destination: '/stories', permanent: true },
      { source: '/stories/lake-wylie', destination: '/stories', permanent: true },
      { source: '/stories/lancaster', destination: '/stories', permanent: true },
      { source: '/stories/landis', destination: '/stories', permanent: true },
      { source: '/stories/locust', destination: '/stories', permanent: true },
      { source: '/stories/marvin', destination: '/stories', permanent: true },
      { source: '/stories/midland', destination: '/stories', permanent: true },
      { source: '/stories/mount-pleasant', destination: '/stories', permanent: true },
      { source: '/stories/mt-holly', destination: '/stories', permanent: true },
      { source: '/stories/norwood', destination: '/stories', permanent: true },
      { source: '/stories/sherrills-ford', destination: '/stories', permanent: true },
      { source: '/stories/stallings', destination: '/stories', permanent: true },
      { source: '/stories/tega-cay', destination: '/stories', permanent: true },
      { source: '/stories/terrell', destination: '/stories', permanent: true },
      { source: '/stories/unionville', destination: '/stories', permanent: true },
