  ...
  return (
    <>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-primary mb-6 text-center">Why We&apos;re Lake Norman&apos;s Most Trusted Roofer</h2>
            <p className="text-gray text-lg text-center mb-8">
              Our commitment to Lake Norman goes beyond roofing. We are active members of the{' '}
              ...
              Keller Williams Lake Norman agents trust us as their preferred roofing contractor for pre-listing inspections and buyer-requested roof work.
            </p>
