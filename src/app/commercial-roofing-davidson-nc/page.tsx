...
export const metadata: Metadata = {
  ...
  description:
    'Commercial roofing services in Davidson NC. Best Roofing Now installs TPO, EPDM, metal, and flat roofing systems for businesses. Licensed, insured. Free estimates!',
  keywords: [
...
const roofingSystems = [
  { title: 'TPO Roofing', description: 'Energy-efficient single-ply membrane for flat roofs.', popular: true },
  { title: 'EPDM Roofing', description: 'Durable rubber membrane with excellent weather resistance.' },
  { title: 'Metal Roofing', description: 'Standing seam and panel systems for commercial buildings.' },
  { title: 'Modified Bitumen', description: 'Multi-layer asphalt system for waterproofing.' },
  { title: 'Built-Up Roofing', description: 'Traditional multi-ply system with proven performance.' },
  { title: 'Roof Coatings', description: 'Extend roof life with reflective coatings.' },
];

const commercialServices = [
  { icon: Building2, title: 'New Construction', description: 'Complete roofing for new buildings.' },
  { icon: Wrench, title: 'Roof Replacement', description: 'Full tear-off and modern replacement.' },
...
const faqs = [
  { question: 'What commercial roofing systems do you install?', answer: 'We install TPO, EPDM, PVC, modified bitumen, BUR, metal roofing, and coatings.' },
  { question: 'How much does commercial roofing cost in Davidson?', answer: 'Costs vary by size and system. TPO/EPDM typically runs $5-10 per square foot installed.' },
  { question: 'Can you work around our business hours?', answer: 'Yes! We schedule during off-hours, weekends, or phases to minimize disruption.' },
  { question: 'Do you offer commercial roof maintenance?', answer: 'Yes, we offer preventive maintenance programs to extend roof lifespan.' },
  { question: 'What warranties do you offer?', answer: 'Manufacturer warranties up to 30 years plus our workmanship warranty.' },
  { question: 'How long does installation take?', answer: 'Small roofs take 3-5 days, larger projects 2-4 weeks.' },
];
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-lg text-white/80 mb-8 max-w-2xl">
              Best Roofing Now provides expert commercial roofing throughout Davidson. From new installations to repairs, we deliver quality solutions for businesses.
            </p>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-gray text-lg">We install all major commercial roofing systems.</p>
          </div>
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-white/90">Get a free estimate for your business.</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4">
