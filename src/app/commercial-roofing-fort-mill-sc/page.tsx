...
export default function CommercialRoofingFortMillSCPage() {
  return (
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Commercial Roofing Fort Mill SC', url: `${SITE_CONFIG.url}/commercial-roofing-fort-mill-sc` },
        ]}
      />
      <FAQSchema faqs={faqs} />
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 bg-white/15 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-sm font-semibold">Fort Mill&apos;s Growing Business Community | SC Licensed</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-6">
              Kingsley, Baxter & I-77 Commercial Roofing Specialists
            </p>
            <p className="text-lg text-white/80 mb-8 max-w-2xl">
              Best Roofing Now delivers professional commercial roofing solutions throughout Fort Mill and York County SC.
              From Kingsley corporate offices to Baxter Village retail, our certified team provides exceptional
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Complete Commercial Roofing Services in Fort Mill SC
            </h2>
            <p className="text-gray text-lg">
              From flat roof installations to emergency repairs, Best Roofing Now provides comprehensive commercial
              roofing solutions for Fort Mill&apos;s growing business community.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-primary mb-6">
                Why Fort Mill Businesses Choose Best Roofing Now
              </h2>
              <p className="text-gray text-lg mb-8">
                When your commercial property needs roofing work, you need a contractor who understands the needs
                of Fort Mill&apos;s professional business community. We deliver quality with minimal disruption.
              </p>
            ...
            <div className="relative">
              <Image
                ...
                alt="Commercial roofing Fort Mill SC - Office building"
                width={600}
                height={450}
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Commercial Properties We Serve in Fort Mill SC
            </h2>
            <p className="text-gray text-lg">
              From corporate campuses to retail centers, we provide expert commercial roofing for every building type.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold mb-2 text-white">
                Need Commercial Roofing in Fort Mill SC?
              </h2>
      ...
      <section className="section bg-light">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Commercial Roofing Throughout Fort Mill & York County SC
            </h2>
            <p className="text-gray text-lg">
              We provide commercial roofing services to businesses throughout Fort Mill and the greater Charlotte metro.
            </p>
          </div>

          <div className="grid lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h3 className="text-xl font-bold text-dark mb-4">Fort Mill Commercial Districts</h3>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-gray text-lg">
              We install and service all major commercial roofing systems for Fort Mill businesses.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-light rounded-xl p-6">
              ...
              <p className="text-gray text-sm">
                ...
                office and retail buildings. 25+ year lifespan.
              </p>
            </div>
            <div className="bg-light rounded-xl p-6">
            ...
            <div className="bg-light rounded-xl p-6">
              ...
              <p className="text-gray text-sm">
                ...
                Premium appearance for corporate buildings.
              </p>
            </div>
            <div className="bg-light rounded-xl p-6">
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
                Commercial Roofing Fort Mill SC FAQs
              </h2>
              <p className="text-gray text-lg">
                Answers to common questions about commercial roofing services in Fort Mill SC.
              </p>
            </div>
