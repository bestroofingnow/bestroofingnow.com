...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Emergency Roof Repair Davidson NC | 24/7 Service | Best Roofing Now',
    description:
      '24/7 emergency roof repair in Davidson NC. Fast response for storm damage, active leaks, and urgent repairs. BBB A+ rated, veteran-owned. Call now!',
    url: `${SITE_CONFIG.url}/emergency-roof-repair-davidson-nc`,
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Emergency roof repair services in Davidson NC - Best Roofing Now',
      },
    ],
  },
};
...
const emergencyServices = [
  {
    ...
    description: 'Immediate response for wind, hail, and severe weather damage to protect your Davidson home - historic or new construction.',
    href: '/services/storm-damage',
  },
  {
    icon: CloudRain,
    title: 'Active Leak Repair',
    description: 'Fast repair for active roof leaks to prevent water damage to your Davidson home\'s interior and belongings.',
    href: '/services/roof-repair',
  },
  {
    icon: TreePine,
    title: 'Fallen Tree/Debris',
    description: 'Emergency removal of trees and debris from storms and immediate roof protection for Davidson properties.',
    href: '/services/emergency-roofing',
  },
  {
    icon: Shield,
    title: 'Emergency Tarping',
    description: 'Temporary tarping to protect your Davidson home until permanent repairs can be completed.',
    href: '/services/emergency-roofing',
  },
  {
    icon: Wrench,
    title: 'Urgent Repairs',
    description: 'Same-day repairs for missing shingles, exposed decking, and other urgent issues in Davidson.',
    href: '/services/roof-repair',
  },
  {
    icon: Home,
    title: 'Insurance Documentation',
    description: 'Thorough documentation and photos for insurance claims after emergency events in Davidson.',
    href: '/services/storm-damage',
  },
];
...
const whyChooseUs = [
  ...
  },
  {
    icon: Zap,
    title: 'Fast Response',
    description: 'We respond to emergencies within 1-4 hours in the Davidson and Lake Norman area.',
  },
  {
    icon: Award,
    title: 'BBB A+ Rated',
  ...
  },
  {
    ...
    description: `${SITE_CONFIG.googleReviewCount}+ five-star reviews from Davidson and Lake Norman homeowners.`,
  },
];
...
// FAQs about emergency roof repair in Davidson
const faqs = [
  {
    question: 'How quickly can you respond to a roof emergency in Davidson?',
    answer:
      'Our emergency team is just 25-40 minutes from Davidson, depending on the neighborhood. For active leaks, storm damage, or safety hazards, we prioritize rapid response. Call us 24/7 at (704) 605-6047 for immediate assistance.',
  },
  {
    question: 'Do you provide 24/7 emergency roofing service in Davidson?',
    answer:
      'Yes! Best Roofing Now offers true 24/7 emergency roofing services in Davidson and throughout the Lake Norman area. Whether it\'s 2 AM on a Sunday or during a holiday, we\'re available when you need us most. Our after-hours line is always staffed.',
  },
  {
    question: 'Do you work on historic homes in Davidson?',
    answer:
      'Absolutely. Davidson has a rich architectural heritage with many historic homes near the college and along South Main. We have experience working with older roofing systems and can match materials to maintain the character of your historic Davidson home while ensuring proper protection.',
  },
  {
    question: 'How much does emergency roof repair cost in Davidson?',
    answer:
  ...
  {
    question: 'Will you help with my insurance claim for storm damage in Davidson?',
    answer:
  ...
  },
  {
    ...
    answer:
      'We provide emergency roofing services throughout all of Davidson including Davidson Village, River Run, Westbranch, Davidson Bay, Summers Walk, McConnell, South Main, Bradford, and the Davidson College area. We also cover nearby communities including Cornelius, Huntersville, Mooresville, and Denver.',
  },
];

export default function EmergencyRoofRepairDavidsonNCPage() {
  return (
    <>
      <BreadcrumbSchema
        items={[
          { name: 'Home', url: SITE_CONFIG.url },
          { name: 'Emergency Roof Repair Davidson NC', url: `${SITE_CONFIG.url}/emergency-roof-repair-davidson-nc` },
        ]}
      />
      <FAQSchema faqs={faqs} />
      <LocalBusinessSchema includeRating={true} />
      <AISearchOptimizationBundle
        pageUrl={`${SITE_CONFIG.url}/emergency-roof-repair-davidson-nc`}
        pageName="Emergency Roof Repair Davidson NC"
        city="Davidson"
      />
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 text-white leading-tight">
              ...
              <span className="text-yellow-300">Davidson NC</span>
            </h1>
            <p className="text-xl md:text-2xl text-white/90 mb-6">
              Fast 25-40 minute response for storm damage, leaks & urgent repairs - 24/7
            </p>
            <p className="text-lg text-white/80 mb-8 max-w-2xl">
              Roof emergency in Davidson? Don't wait! Best Roofing Now provides immediate emergency roofing
              services throughout Davidson's college town community. From historic homes near Davidson College
              to newer neighborhoods, our team responds quickly to protect your home and family.
            </p>
        ...
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Emergency Roofing Services in Davidson NC
            </h2>
            <p className="text-gray text-lg">
              When disaster strikes your Davidson home, our emergency team is ready to protect it with fast,
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-center md:text-left">
            ...
            <div>
              ...
              <p className="text-white/90">Don't wait - call us immediately for fast response in Davidson.</p>
            </div>
            <Button
              href={`tel:${SITE_CONFIG.phoneClean}`}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-primary mb-6">
                Why Davidson Trusts Us for Emergency Roofing
              </h2>
              <p className="text-gray text-lg mb-8">
                ...
                to protect Davidson homes - from historic properties near the college to newer communities - around the clock.
              </p>
            ...
            <div className="relative">
              <Image
                ...
                alt="Best Roofing Now - Emergency roof repair team serving Davidson NC"
                width={600}
                height={450}
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-gray text-lg">
              Follow these steps if you experience roof damage in Davidson.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-light rounded-xl p-6 text-center">
              ...
              <p className="text-gray text-sm">
                Call (704) 605-6047 for immediate 24/7 emergency response in Davidson.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section bg-light">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
              24/7 Emergency Coverage in Davidson & Beyond
            </h2>
            <p className="text-gray text-lg">
              We provide emergency roofing services throughout Davidson and the surrounding Lake Norman communities.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h3 className="text-xl font-bold text-dark mb-4">Davidson Areas We Cover</h3>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Common Roofing Emergencies in Davidson
            </h2>
            <p className="text-gray text-lg">
              Davidson's mix of historic and newer homes, combined with Lake Norman weather patterns, creates unique roofing challenges. We're ready for any emergency.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-light rounded-xl p-6">
              ...
              <p className="text-gray text-sm">
                Davidson experiences strong storms with high winds and hail that can damage both historic and modern roofs.
            ...
            <div className="bg-light rounded-xl p-6">
              ...
              <p className="text-gray text-sm">
                ...
                fast to protect your Davidson home and belongings.
              </p>
            </div>
            <div className="bg-light rounded-xl p-6">
              <h3 className="font-bold text-dark mb-2">Fallen Trees & Debris</h3>
              <p className="text-gray text-sm">
                Davidson's tree-lined streets and mature canopy can become hazards during storms. We safely remove debris, tarp
            ...
            <div className="bg-light rounded-xl p-6">
              ...
              <p className="text-gray text-sm">
                ...
                inspections and help Davidson homeowners with insurance claims.
              </p>
            </div>
            <div className="bg-light rounded-xl p-6">
              <h3 className="font-bold text-dark mb-2">Flashing Failures</h3>
              <p className="text-gray text-sm">
                Failed flashing around chimneys and vents can cause sudden leaks, especially in Davidson's older homes. We repair or replace
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
                Emergency Roof Repair FAQs for Davidson
              </h2>
              <p className="text-gray text-lg">
                Answers to common questions about emergency roofing services in Davidson NC.
              </p>
            </div>
      ...
      <GeoProjectGalleryStrip pageType="location" city="Davidson" slug="emergency-roof-repair-davidson-nc" />
      ...
      <section className="bg-accent text-white py-16">
        <div className="container text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
            Roof Emergency in Davidson?
          </h2>
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Don't wait for the damage to get worse. Our emergency team is standing by 24/7 to protect your Davidson home.
          </p>
