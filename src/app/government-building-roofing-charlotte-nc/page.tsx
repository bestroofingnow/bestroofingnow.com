...
export const metadata: Metadata = {
  ...
  description:
    'Expert government building roofing contractors in Charlotte NC serving Mecklenburg County facilities, City of Charlotte buildings.',
  alternates: {
  ...
  return (
    <>
      ...
      <GeoProjectGalleryStrip
        pageType="other"
        city="Charlotte"
        slug="government-building-roofing-charlotte-nc"
        count={4}
        title="Recent Roofing Projects in Charlotte, NC"
        subtitle="Browse completed roofing projects from the Charlotte area by Best Roofing Now."
        schemaPageUrl={`${SITE_CONFIG.url}/government-building-roofing-charlotte-nc`}
      />
