...
const gutterServices = [
  ...
  { icon: Shield, title: 'Gutter Guards', description: 'Keep debris out and reduce maintenance with quality gutter protection.' },
  { icon: Home, title: 'Gutter Replacement', description: 'Full gutter system replacement including downspouts and hangers.' },
  { icon: CheckCircle, title: 'Downspout Installation', description: 'Proper downspout placement to direct water away from foundation.' },
  { icon: Award, title: 'Copper Gutters', description: 'Premium copper gutter systems for distinctive homes.' },
...
const faqs = [
  { question: 'How much do new gutters cost in Matthews NC?', answer: 'Gutter installation in Matthews typically costs $1,200 to $4,000 for most homes, depending on linear footage and material choice.' },
  { question: 'What size gutters do I need?', answer: 'Most Matthews homes use 5-inch K-style gutters, though 6-inch may be recommended for large roof areas.' },
  { question: 'Are seamless gutters worth it?', answer: 'Yes! Seamless gutters have fewer joints, meaning fewer potential leak points and longer lifespan.' },
  { question: 'Do you install gutter guards?', answer: 'Yes, we offer several gutter guard options to reduce maintenance and prevent clogs.' },
  { question: 'How long do gutters last?', answer: 'Aluminum gutters typically last 20-30 years, while copper gutters can last 50+ years.' },
  { question: 'Can you match my existing gutter color?', answer: 'Yes! We offer gutters in a wide range of colors to match your home\'s exterior.' },
];
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-lg text-white/80 mb-8 max-w-2xl">
              Protect your home from water damage with quality gutter installation from Best Roofing Now. We install seamless aluminum, copper, and steel gutters throughout Matthews.
            </p>
