...
export const metadata: Metadata = {
  ...
  description:
    'Fast and affordable gutter repair in Charlotte NC. Best Roofing Now offers gutter repair, cleaning, and replacement services. BBB A+ rated, veteran-owned.',
  alternates: {
  ...
  return (
    <>
      ...
      <GeoProjectGalleryStrip
        pageType="other"
        city="Charlotte"
        slug="gutter-repair-charlotte-nc"
        count={4}
        title="Recent Roofing Projects in Charlotte, NC"
        subtitle="Browse completed roofing projects from the Charlotte area by Best Roofing Now."
        schemaPageUrl={`${SITE_CONFIG.url}/gutter-repair-charlotte-nc`}
      />
