...
export default function IndustrialRoofingCharlotteNCPage() {
  return (
    <>
      ...
      {/* Industrial Instant Estimate Section */}
        ...
        <div className="container">
          <div className="text-center max-w-4xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
              Industrial Roof Instant Estimate
            </h2>
            <p className="text-xl text-white/90 mb-2">
              Get an instant price range for your industrial roofing project — no waiting, no hassle.
            </p>
          </div>
      ...
      <GeoProjectGalleryStrip
        pageType="other"
        city="Charlotte"
        slug="industrial-roofing-charlotte-nc"
        count={4}
        title="Recent Roofing Projects in Charlotte, NC"
        subtitle="Browse completed roofing projects from the Charlotte area by Best Roofing Now."
        schemaPageUrl={`${SITE_CONFIG.url}/industrial-roofing-charlotte-nc`}
      />
