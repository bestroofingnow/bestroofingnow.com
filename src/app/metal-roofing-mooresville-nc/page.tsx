...
import { BreadcrumbSchema, FAQSchema, LocationSchema, AISearchOptimizationBundle, VoiceSearchActionSchema, SpeakableContentBlocks } from '@/components/seo/SchemaMarkup';
...
export default function MetalRoofingMooresvilleNCPage() {
  ...
  county: 'Iredell',
      ...
      <AISearchOptimizationBundle
        pageUrl={`${SITE_CONFIG.url}/metal-roofing-mooresville-nc`}
        pageName="Metal Roofing Mooresville NC"
        city="Mooresville"
      />
