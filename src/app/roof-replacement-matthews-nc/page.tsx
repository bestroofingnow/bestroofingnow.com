...
// Why replace
const whyReplace = [
  { title: 'Roof Age', description: 'Asphalt shingle roofs typically last 20-25 years. If yours is approaching this age, replacement is wise.' },
  { title: 'Frequent Repairs', description: 'If you\'re constantly repairing your roof, replacement may be more cost-effective.' },
...
export default function RoofReplacementMatthewsNCPage() {
  return (
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Matthews NC', url: `${SITE_CONFIG.url}/roof-replacement-matthews-nc` },
        ]}
      />
      <FAQSchema faqs={faqs} />
      ...
      <AISearchOptimizationBundle
        pageUrl={`${SITE_CONFIG.url}/roof-replacement-matthews-nc`}
        pageName="Roof Replacement Matthews NC"
        city="Matthews"
      />
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-lg text-white/80 mb-8 max-w-2xl">
              ...
              with premium materials and industry-leading warranties. We serve Matthews and
              South Charlotte with certified craftsmanship.
            </p>
        ...
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Roofing Materials for Matthews Homes
            </h2>
            <p className="text-gray text-lg">
              We install premium roofing materials from industry-leading manufacturers, backed by comprehensive warranties.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {materials.map((material) => (
              ...
              >
                ...
                <p className={material.popular ? 'text-white/90' : 'text-gray'}>{material.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="section bg-light">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-gray text-lg">
              Not sure if you need a new roof? Here are common reasons Matthews homeowners choose replacement.
            </p>
          </div>
      ...
      <section className="bg-accent text-white py-12">
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold mb-2 text-white">Ready for a New Roof in Matthews?</h2>
              <p className="text-white/90">Get a free estimate with transparent pricing and financing options.</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                href="/contact"
      ...
      <GeoProjectGalleryStrip
        ...
        count={4}
        title="Recent Roof Replacements in Matthews"
        subtitle="Browse completed roof replacement projects from the Matthews area."
        schemaPageUrl={`${SITE_CONFIG.url}/roof-replacement-matthews-nc`}
      />
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Roof Replacement FAQs</h2>
            </div>
      ...
      <ServiceCityLinks
        ...
        subtitle="Beyond replacement, we offer comprehensive roofing solutions."
      />
      ...
      <CTASection
        title="Ready for Your New Roof in Matthews?"
        subtitle="Get a free estimate with detailed material options and transparent pricing. Financing available."
      />
    </>
  );
}
