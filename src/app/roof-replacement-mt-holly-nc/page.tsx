...
export const metadata: Metadata = {
  ...
  description:
    'Need a new roof in Mt Holly NC? Best Roofing Now provides expert roof replacement with premium materials and warranties. BBB A+ rated, veteran-owned.',
  alternates: {
  ...
  return (
    <>
      ...
      <ServiceAreaPageSchema
        city="Mt Holly"
        state="NC"
        slug="roof-replacement-mt-holly-nc" pagePath="/roof-replacement-mt-holly-nc"
        distance={15}
      />
