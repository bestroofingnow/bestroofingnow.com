...
export const metadata: Metadata = {
  ...
  description:
    'Looking for a trusted roofer in Ballantyne Charlotte NC? Best Roofing Now serves the Ballantyne Corporate Park area with premium roofing services for…',
  alternates: {
...
export default function RoofingBallantyneCharlotteNCPage() {
  ...
  or a family home in one of the area's many desirable neighborhoods, our team delivers roofing solutions
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-light rounded-xl p-6 text-center shadow-md">
              ...
              <p className="text-gray text-sm">
                Better Business Bureau A+ rating with zero complaints. Trusted by Ballantyne homeowners.
              </p>
            </div>
          </div>
        </div>
      ...
      <GeoProjectGalleryStrip
        pageType="other"
        city="Charlotte"
        slug="roofing-ballantyne-charlotte-nc"
        count={4}
        title="Recent Roofing Projects in Charlotte, NC"
        subtitle="Browse completed roofing projects from the Charlotte area by Best Roofing Now."
        schemaPageUrl={`${SITE_CONFIG.url}/roofing-ballantyne-charlotte-nc`}
      />
