...
export const metadata: Metadata = {
  ...
  description:
    'Looking for a trusted roofing company in Davidson NC? Best Roofing Now serves Davidson and Lake Norman from our Charlotte headquarters.',
  alternates: {
  ...
  return (
    <>
      ...
      <ServiceAreaPageSchema
        city="Davidson"
        state="NC"
        slug="roofing-davidson-nc" pagePath="/roofing-davidson-nc"
        distance={20}
      />
      <AISearchOptimizationBundle
        pageUrl={`${SITE_CONFIG.url}/roofing-davidson-nc`}
        pageName="Roofing Davidson NC"
        city="Davidson"
      />
      <VoiceSearchActionSchema />
      <SpeakableContentBlocks city="Charlotte" />
      <LKNHowToBundle pageUrl={`${SITE_CONFIG.url}/roofing-davidson-nc`} city={"Davidson"} />
      ...
      <LKNNeighborhoodGrid currentCity="Davidson" currentSlug="roofing-davidson-nc" />
