...
export const metadata: Metadata = {
  ...
  description:
    'Looking for top-rated roofers in Huntersville NC? Best Roofing Now provides expert roofing services to Huntersville and the Lake Norman area.',
  alternates: {
  ...
  return (
    <>
      ...
      <ServiceAreaPageSchema
        city="Huntersville"
        state="NC"
        slug="roofing-huntersville-nc" pagePath="/roofing-huntersville-nc"
        distance={20}
      />
