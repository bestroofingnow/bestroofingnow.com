...
export const metadata: Metadata = {
  ...
  description:
    'Looking for a trusted roofing contractor in Mooresville NC? Best Roofing Now serves Mooresville and Lake Norman from our Charlotte headquarters.',
  alternates: {
  ...
  return (
    <>
      ...
      <ServiceAreaPageSchema
        city="Mooresville"
        state="NC"
        slug="roofing-mooresville-nc" pagePath="/roofing-mooresville-nc"
        distance={30}
      />
      <AISearchOptimizationBundle
      ...
      <section className="py-10 bg-light">
        <div className="container">
          <h2 className="text-xl font-bold text-primary mb-4 text-center">Mooresville Roofing Cost Guides</h2>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Link href="/shingle-vs-metal-roof-cost" className="bg-white rounded-full px-4 py-2 text-sm font-medium text-primary hover:bg-primary hover:text-white transition-colors">Shingles vs Metal</Link>
