...
export const metadata: Metadata = {
  ...
  description:
    'Looking for a trusted roofer in Myers Park Charlotte NC? Best Roofing Now specializes in luxury home roofing with premium materials for large estates.',
  alternates: {
...
export default function RoofingMyersParkCharlotteNCPage() {
  ...
  or a beautiful Colonial on Cherokee Road, our team delivers premium roofing solutions that
      ...
      <GeoProjectGalleryStrip
        pageType="other"
        city="Charlotte"
        slug="roofing-myers-park-charlotte-nc"
        count={4}
        title="Recent Roofing Projects in Charlotte, NC"
        subtitle="Browse completed roofing projects from the Charlotte area by Best Roofing Now."
        schemaPageUrl={`${SITE_CONFIG.url}/roofing-myers-park-charlotte-nc`}
      />
