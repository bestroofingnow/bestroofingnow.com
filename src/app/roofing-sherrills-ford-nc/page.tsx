...
export const metadata: Metadata = {
  ...
  description:
    'Looking for roofing services in Sherrills Ford NC? Best Roofing Now serves Sherrills Ford and the Lake Norman area from our Charlotte headquarters.',
  alternates: {
...
export default function RoofingSherrillsFordNCPage() {
  ...
  and proper ridge ventilation.
      ...
      <GeoProjectGalleryStrip
        pageType="location"
        city="Denver"
        slug="roofing-sherrills-ford-nc"
        count={4}
        title="Recent Roofing Projects in Sherrills Ford, NC"
        subtitle="Browse completed roofing projects from the Sherrills Ford area by Best Roofing Now."
        schemaPageUrl={`${SITE_CONFIG.url}/roofing-sherrills-ford-nc`}
      />
