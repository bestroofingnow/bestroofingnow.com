...
export const metadata: Metadata = {
  ...
  description:
    'Looking for a trusted roofer in University City Charlotte NC? Best Roofing Now serves the UNCC area with professional roofing services for homes.',
  alternates: {
...
export default function RoofingUniversityCityCharlotteNCPage() {
  return (
    <>
      ...
      <AISearchOptimizationBundle
        pageUrl={`${SITE_CONFIG.url}/roofing-university-city-charlotte-nc`}
        pageName="Roofing University City Charlotte NC"
        city="Charlotte"
      />
  ...
  or a property manager overseeing student housing, we provide professional roofing services at prices
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-light rounded-xl p-6 text-center shadow-md">
              ...
              <p className="text-gray text-sm">
                Better Business Bureau A+ rating with zero complaints. Trusted by University City homeowners.
              </p>
            </div>
          </div>
        </div>
      ...
      <GeoProjectGalleryStrip
        pageType="other"
        city="Charlotte"
        slug="roofing-university-city-charlotte-nc"
        count={4}
        title="Recent Roofing Projects in Charlotte, NC"
        subtitle="Browse completed roofing projects from the Charlotte area by Best Roofing Now."
        schemaPageUrl={`${SITE_CONFIG.url}/roofing-university-city-charlotte-nc`}
      />
