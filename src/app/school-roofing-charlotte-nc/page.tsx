...
export const metadata: Metadata = {
  ...
  description:
    'Expert school and educational facility roofing contractors in Charlotte NC. Serving CMS schools, universities, private schools & colleges.',
  alternates: {
...
export default function SchoolRoofingCharlotteNCPage() {
  ...
  public procurement processes, and long-term budget planning all demand a contractor who truly understands
      ...
      <GeoProjectGalleryStrip
        pageType="other"
        city="Charlotte"
        slug="school-roofing-charlotte-nc"
        count={4}
        title="Recent Roofing Projects in Charlotte, NC"
        subtitle="Browse completed roofing projects from the Charlotte area by Best Roofing Now."
        schemaPageUrl={`${SITE_CONFIG.url}/school-roofing-charlotte-nc`}
      />
