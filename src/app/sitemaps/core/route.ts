...
export async function GET() {
  const pages = [
    ...
    { url: `${BASE_URL}/leaking-roof-repair-charlotte-nc`, changefreq: 'weekly', priority: '0.9' },
    ...
    { url: `${BASE_URL}/commercial-roofing-contractors-charlotte-nc`, changefreq: 'weekly', priority: '0.9' },
