...
export const metadata: Metadata = {
  ...
  description:
    'Professional skylight installation in Charlotte NC. VELUX certified installers offering fixed, venting, and tubular skylights.',
  alternates: {
  ...
  return (
    <>
      ...
      <GeoProjectGalleryStrip
        pageType="other"
        city="Charlotte"
        slug="skylight-installation-charlotte-nc"
        count={4}
        title="Recent Roofing Projects in Charlotte, NC"
        subtitle="Browse completed roofing projects from the Charlotte area by Best Roofing Now."
        schemaPageUrl={`${SITE_CONFIG.url}/skylight-installation-charlotte-nc`}
      />
