...
export const metadata: Metadata = {
  ...
  description:
    'Solar roofing for Lake Norman waterfront and lakefront homes. GAF Timberline Solar shingles, solar panel integration for Cornelius, Davidson, Mooresville.',
  alternates: {
  ...
  return (
    <>
      ...
      <ServiceAreaPageSchema
        city="Lake Norman"
        state="NC"
        slug="solar-roofing-lake-norman-nc" pagePath="/solar-roofing-lake-norman-nc"
        distance={25}
      />
