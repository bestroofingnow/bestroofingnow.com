...
export const metadata: Metadata = {
  ...
  description:
    'Best Roofing Now is a veteran-owned, family-operated roofing company in Charlotte NC. Founded on military values of integrity, discipline, and excellence.',
  alternates: {
...
export default function VeteranOwnedRoofingCompanyCharlotteNCPage() {
  ...
  you are keeping your dollars local and supporting a family that gives back.
      ...
      <GeoProjectGalleryStrip
        pageType="other"
        city="Charlotte"
        slug="veteran-owned-roofing-company-charlotte-nc"
        count={4}
        title="Recent Roofing Projects in Charlotte, NC"
        subtitle="Browse completed roofing projects from the Charlotte area by Best Roofing Now."
        schemaPageUrl={`${SITE_CONFIG.url}/veteran-owned-roofing-company-charlotte-nc`}
      />
