...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles = cn(
      'inline-flex items-center justify-center gap-2.5 font-semibold uppercase tracking-[0.08em] cursor-pointer',
      'rounded-[2px] transition-[color,background-color,border-color] duration-200',
