...
export const SERVICES = [
  ...
  },
  {
    ...
    longDescription: 'The best way to maximize your roof\'s lifespan is through regular professional maintenance. Our roof maintenance programs include annual inspections, minor preventive repairs, debris removal, and detailed condition reports. Catching small issues before they become big problems can save thousands in repair costs and add years to your roof\'s life.',
    icon: 'Settings',
    keywords: ['roof maintenance Charlotte NC', 'roof tune-up', 'preventive roof care', 'roof maintenance program'],
    priceRange: '$150 - $400 per visit',
    timeline: '1-2 hours per visit',
    charlotteNote: 'Charlotte\'s mix of hot summers, occasional ice, and frequent storms makes regular maintenance especially valuable. Our programs can extend your roof life by 5-10 years.',
  },
  {
